...
public class Main {
    ...
    public static void main(String[] args) {
        GryffindorStudent harry = generaleGryffindorStudent(" Гарри Поттер ");
        GryffindorStudent ron = generaleGryffindorStudent(" Рон Уизли ");
        RavenclawStudent luna = generateRavenclawStudent(" Полумна Лавгуд ");
        SlytherinStudent draco = generateSlytherinStudent(" Седрик Диггори ");
    ...
    private static GryffindorStudent generaleGryffindorStudent(String name) {
